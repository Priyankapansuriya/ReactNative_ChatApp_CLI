  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{
        ...
        <Stack.Screen name="Signup_ChooseUsername" component={Signup_ChoseUsername} />
        ...
        <Stack.Screen name="ForgetPassword_AccountRecoverd" component={ForgetPassword_AccountRecoverd} />
