...
import {formHead,formInput,formTextLinkRight,formbtn,formTextLinkCenter} from '../../../Common/Formcss';
...
const Login = ({navigation}) => {
  return (
    <View style={containerFull}>
      ...
      <Text style={formTextLinkRight} onPress={() => navigation.navigate('ForgetPassword_EnterEmail')}>Forgot Password?</Text>
      <Text style={formbtn} onPress={() => navigation.navigate('Mainpage')}>Login</Text>
